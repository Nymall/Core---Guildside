                ...
                if entity.item and entity.x == player.x and entity.y == player.y:
                    if entity.name == 'pool of blud':
                        ...
                        if player.fighter.max_blood < player.fighter.blood:
                            message_log.add_message(Message('You cannot contain that much blud!', libtcod.yellow))
                            if player.fighter.hp < player.fighter.max_hp:
                                message_log.add_message(Message('You are healed by some of the escaping blud essence!', libtcod.yellow))
                                player.fighter.hp += randint(1,5)
                            else:
                                message_log.add_message(Message('The essence escapes into the Aether. What a waste.', libtcod.blue))
